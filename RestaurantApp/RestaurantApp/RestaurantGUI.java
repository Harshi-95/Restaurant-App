...
public class RestaurantGUI extends JFrame {
    ...
    private JPanel createWelcomePage() {
        ...
        BackgroundPanel panel = new BackgroundPanel("images/welcome.jpg");
        panel.setLayout(new BorderLayout());
        
        // Transparent overlay panel for title at the top
        JPanel topPanel = new JPanel(new BorderLayout());
        topPanel.setOpaque(false);
        JLabel titleLabel = new JLabel("Welcome to Flavor Junction", JLabel.CENTER);
        ...
        enterBtn.addActionListener(e -> {
            ...
            if(customerName.isEmpty() || tableNumber.isEmpty()){
                JOptionPane.showMessageDialog(panel, "Please enter both your name and table number.", "Input Error", JOptionPane.ERROR_MESSAGE);
            } else {
                ...
                if (dishes != null) {
                    for (Object[] dish : dishes) {
                        ...
                        addBtn.addActionListener(ev -> {
                            ...
                            total += price;
                            JOptionPane.showMessageDialog(panel, name + " added to cart.", "Item Added", JOptionPane.INFORMATION_MESSAGE);
                        });
   ...
   // 4. Payment & Receipt Page with full background image
private JPanel createPaymentPage() {
    // Load the background image
    ImageIcon backgroundIcon = new ImageIcon("C:/Users/Harshita/Music/RestaurantApp/RestaurantApp/images/decor_payment.jpg");
    Image backgroundImage = backgroundIcon.getImage();

    // Create panel with custom paint for background
    JPanel panel = new JPanel(new BorderLayout()) {
        @Override
        protected void paintComponent(Graphics g) {
            super.paintComponent(g);
    ...
    panel.add(paymentTitle, BorderLayout.NORTH);
